...
const navigation: NavItem[] = [
  ...
  { title: 'Project Setup', href: '/project-setup', icon: '🏗️' },
  { title: 'Daily Workflow', href: '/daily-workflow', icon: '💻' },
  { title: 'Advanced Tips', href: '/advanced', icon: '🔧' },
  { title: 'Live Examples', href: '/examples', icon: '🎮' },
];
